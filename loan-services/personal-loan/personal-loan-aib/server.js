...
app.listen(port, async () => {
    ...
    try {
        const res = await axios.post('http://personal-loan-registry:6000/register', {
            serviceName: 'personal-loan-aib',
            // serviceUrl: `http://personalloan-aib:${port}`
            serviceUrl: `http://personal-loan-aib:${port}`
        });
